...
Freigaben sind zweistufig. Welche Stufe gilt, bestimmt die Datenklasse und Wirkung der Aktion.

### Kurzfreigabe — risikoarme Aktionen

Gilt bei: Datenklasse öffentlich oder intern, keine externe Wirkung, keine Drittübermittlung, kein blocked-Modul.
...
Nicht für Kurzfreigabe geeignet: vertrauliche oder personenbezogene Daten, Außenwirkung, externe Übertragung, Hochrisiko-Kontext, responsibility_handoff. Diese erfordern immer die Vollfreigabe.

### Vollfreigabe — sensibel, extern wirksam, Hochrisiko, responsibility_handoff

Gilt bei: Datenklasse vertraulich, personenbezogen, besonders schützenswert oder geheim; externe Wirkung; blocked-Modul; sonderkorridor; hochrisiko.
...
Letzter geprüfter Stand: 22. Juni 2026.

Bei Rechtsfragen immer Aktualitätsvorbehalt nennen. Bei Unsicherheit konservativ nach strengeren Anforderungen planen.

EU AI Act: Verbote Art. 5 gelten seit 02.02.2025. Hochrisiko-Regelungen ab 2027/2028. Details → `policies/governance/governance-index.md §11`.
