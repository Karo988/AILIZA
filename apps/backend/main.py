...
def _ask_llm_directly(
    ...
    system_prompt = (
        ...
        "\n\n"
        "DSGVO-Platzhalter: Bevor du den Text siehst, wurden personenbezogene und "
        "besonders sensible Daten bereits automatisch und zuverlässig durch Platzhalter "
        "ersetzt. Du bekommst NIEMALS echte Namen, Gesundheits-, Finanz- oder Zugangsdaten "
        "zu sehen — nur diese Platzhalter:\n"
        "- Normale Daten: [Name], [Adresse], [Ort], [E-Mail], [Telefon], [Geburtsdatum], "
        "[IBAN], [BIC], [Kartennummer], [Kartenprüfnummer], [Kartengültigkeit], "
        "[Referenznummer], [Ausweisnummer], [Zugangsdaten], [IP-Adresse], [Standort], "
        "[Gerätekennung], [Finanzangabe], [Systempfad], [Kinderdaten (Art. 8 DSGVO)]\n"
        "- Besonders sensible Daten (Art. 9/10 DSGVO): [GESCHWAERZT: Gesundheit - Art. 9 DSGVO], "
        "[GESCHWAERZT: Religion/Weltanschauung - Art. 9 DSGVO], [GESCHWAERZT: Politische Meinung - "
        "Art. 9 DSGVO], [GESCHWAERZT: Sexualdaten/Familienstand - Art. 9 DSGVO], "
        "[GESCHWAERZT: Herkunft - Art. 9 DSGVO], [GESCHWAERZT: Biometrische Daten - Art. 9 DSGVO], "
        "[GESCHWAERZT: Gewerkschaftsbezug - Art. 9 DSGVO], [GESCHWAERZT: Genetische Daten - "
        "Art. 9 DSGVO], [GESCHWAERZT: Strafrechtliche Informationen - Art. 10 DSGVO]\n"
        "WICHTIG: Auch wenn ein Platzhalter eine DSGVO-Kategorie oder einen Artikel im Namen "
        "trägt (z.B. 'Art. 9 DSGVO'), enthält er KEINE echten Daten — das ist lediglich die "
        "technische Kennzeichnung, dass die Schwärzung an dieser Stelle bereits erfolgreich "
        "stattgefunden hat. Das ist die Bestätigung, dass die Aufgabe sicher ist, kein "
        "Warnsignal. Lehne die Aufgabe deswegen NICHT ab und erkläre NICHT, warum du sie nicht "
        "bearbeiten kannst. Übernimm jeden Platzhalter exakt unverändert in deinen Text — "
        "NICHT erklären, NICHT nachfragen, NICHT ausschmücken, NICHT durch eigene Angaben ersetzen. "
        "\n\n"
