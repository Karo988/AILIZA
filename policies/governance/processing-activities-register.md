...
## VVT-09: Memory / Workspace — Sitzungsübergreifender Kontext

| Feld | Inhalt |
|---|---|
| **Zweck** | Kontexterhalt über Sessions; Nutzerpräferenzen, Projektstände, freigegebene Arbeitsstände |
| **Betroffene Personen** | Nutzer |
| **Datenkategorien** | Nutzerpräferenzen, Projektkontexte, freigegebene Inhalte — potenziell vertraulich; keine Credentials |
| **Empfänger** | Lokaler Workspace (intern); kein externer Transfer |
| **Speicherfrist** | Zweck- und projektbezogen — Frist offen (O-07); Löschung nach Projektabschluss empfohlen |
| **Rechtsgrundlage** | Offen — wahrscheinlich Art. 6 Abs. 1 b) oder f) — zu prüfen |
| **TOMs** | Speicherung nur mit Zweck + Frist + Nutzerfreigabe; keine Credentials in Memory; Pseudonymisierung empfohlen; keine dauerhafte Speicherung ohne explizite Freigabe |
| **Drittlandtransfer** | Nein (lokal) |
| **Risiko** | mittel (vertrauliche Inhalte möglich; fehlende Löschlogik) |
| **Status** | aktiv; Lösch- und Aufbewahrungskonzept offen (O-07) |

---

## VVT-10: Logs — Betriebsprotokollierung

| Feld | Inhalt |
|---|---|
| **Zweck** | Betriebsüberwachung, Fehleranalyse, Betriebsnachweis |
| **Betroffene Personen** | Mittelbar: Nutzer (durch Session-IDs oder Routing-Metadaten) |
| **Datenkategorien** | Systemereignisse, Routing-Entscheidungen, Fehler — kein Roh-PII; nur Datenklassen-Bezeichnungen |
| **Empfänger** | Technischer Betreiber; Logging-Infrastruktur (intern) |
| **Speicherfrist** | Offen — zu definieren (O-07); typisch 30–90 Tage für Betriebslogs |
| **Rechtsgrundlage** | Art. 6 Abs. 1 f) DSGVO (berechtigtes Interesse: Betriebssicherheit) — zu prüfen |
| **TOMs** | Kein Roh-PII in Logs (ag-master §8); Datenklassen-Bezeichnungen statt Rohdaten; Zugriffssteuerung; Speicherfrist definieren |
| **Drittlandtransfer** | Nein (intern) — außer bei externem Hosting (zu prüfen) |
| **Risiko** | niedrig–mittel (kein Roh-PII; aber versehentliche PII-Aufnahme möglich) |
| **Status** | aktiv; Speicherfrist offen (O-07) |
...
|---|---|---|---|---|---|
| VVT-01 | Core — Nutzeranfragen (inkl. ag-allrounder) | aktiv | **offen** | nicht zwingend | **offen** |
...
| VVT-09 | Memory / Workspace | aktiv | nein | nein | nein |
| VVT-10 | Logs | aktiv | nein | nein | nein |
