...
AILIZA_BETA_ACCESS_CODE gesetzt -> die gesamte App (inkl. API) ist nur mit
gueltigem Zugangs-Cookie nutzbar. /health bleibt immer frei. Der Cookie-Wert
ist ein HMAC ueber (Secret-Key, Zugangscode) - kein Klartext-Code im Cookie,
und ein Code-Wechsel invalidiert automatisch alle bestehenden Cookies
(Betreiber-Anpassung ggue. der urspruenglichen Planung).
"""
